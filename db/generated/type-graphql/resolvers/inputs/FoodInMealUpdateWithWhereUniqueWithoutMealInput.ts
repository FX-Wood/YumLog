...
@TypeGraphQL.InputType("FoodInMealUpdateWithWhereUniqueWithoutMealInput", {
  isAbstract: true
})
export class FoodInMealUpdateWithWhereUniqueWithoutMealInput {
  ...
  data!: FoodInMealUpdateWithoutMealInput;
}
