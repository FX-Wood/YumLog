...
const relationResolversInfo = {
  User: ["profile", "role", "meals", "weighIns", "workouts", "recipes"],
  Role: ["users"],
  Profile: ["user"],
  WeighIn: ["user"],
  Workout: ["user"],
...
const modelsInfo = {
  User: ["id", "email", "password", "roleId", "createdAt", "updatedAt"],
  Role: ["id", "name"],
...
const outputsInfo = {
  ...
  UserGroupBy: ["id", "email", "password", "roleId", "createdAt", "updatedAt", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  UserCountAggregate: ["id", "email", "password", "roleId", "createdAt", "updatedAt", "_all"],
  UserAvgAggregate: ["id", "roleId"],
  UserSumAggregate: ["id", "roleId"],
  UserMinAggregate: ["id", "email", "password", "roleId", "createdAt", "updatedAt"],
  UserMaxAggregate: ["id", "email", "password", "roleId", "createdAt", "updatedAt"],
  RoleCount: ["users"],
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "id", "email", "password", "roleId", "createdAt", "updatedAt", "profile", "role", "meals", "weighIns", "workouts", "recipes"],
  UserOrderByWithRelationInput: ["id", "email", "password", "roleId", "createdAt", "updatedAt", "profile", "role", "meals", "weighIns", "workouts", "recipes"],
  UserWhereUniqueInput: ["id", "email"],
  UserOrderByWithAggregationInput: ["id", "email", "password", "roleId", "createdAt", "updatedAt", "_count", "_avg", "_max", "_min", "_sum"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "email", "password", "roleId", "createdAt", "updatedAt"],
  ...
  UserCreateInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "meals", "weighIns", "workouts", "recipes"],
  UserUpdateInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "meals", "weighIns", "workouts", "recipes"],
  UserCreateManyInput: ["id", "email", "password", "roleId", "createdAt", "updatedAt"],
  UserUpdateManyMutationInput: ["email", "password", "createdAt", "updatedAt"],
  RoleCreateInput: ["name", "users"],
  RoleUpdateInput: ["name", "users"],
  ...
  UserCountOrderByAggregateInput: ["id", "email", "password", "roleId", "createdAt", "updatedAt"],
  UserAvgOrderByAggregateInput: ["id", "roleId"],
  UserMaxOrderByAggregateInput: ["id", "email", "password", "roleId", "createdAt", "updatedAt"],
  UserMinOrderByAggregateInput: ["id", "email", "password", "roleId", "createdAt", "updatedAt"],
  ...
  RoleCreateWithoutUsersInput: ["name"],
  ...
  RoleUpdateWithoutUsersInput: ["name"],
  ...
  UserCreateWithoutRoleInput: ["email", "password", "createdAt", "updatedAt", "profile", "meals", "weighIns", "workouts", "recipes"],
  ...
  UserScalarWhereInput: ["AND", "OR", "NOT", "id", "email", "password", "roleId", "createdAt", "updatedAt"],
  UserCreateWithoutProfileInput: ["email", "password", "createdAt", "updatedAt", "role", "meals", "weighIns", "workouts", "recipes"],
  UserCreateOrConnectWithoutProfileInput: ["where", "create"],
  UserUpsertWithoutProfileInput: ["update", "create"],
  UserUpdateWithoutProfileInput: ["email", "password", "createdAt", "updatedAt", "role", "meals", "weighIns", "workouts", "recipes"],
  UserCreateWithoutWeighInsInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "meals", "workouts", "recipes"],
  UserCreateOrConnectWithoutWeighInsInput: ["where", "create"],
  UserUpsertWithoutWeighInsInput: ["update", "create"],
  UserUpdateWithoutWeighInsInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "meals", "workouts", "recipes"],
  UserCreateWithoutWorkoutsInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "meals", "weighIns", "recipes"],
  UserCreateOrConnectWithoutWorkoutsInput: ["where", "create"],
  UserUpsertWithoutWorkoutsInput: ["update", "create"],
  UserUpdateWithoutWorkoutsInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "meals", "weighIns", "recipes"],
  UserCreateWithoutRecipesInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "meals", "weighIns", "workouts"],
  ...
  UserUpdateWithoutRecipesInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "meals", "weighIns", "workouts"],
  ...
  UserCreateWithoutMealsInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "weighIns", "workouts", "recipes"],
  ...
  UserUpdateWithoutMealsInput: ["email", "password", "createdAt", "updatedAt", "profile", "role", "weighIns", "workouts", "recipes"],
  ...
  UserCreateManyRoleInput: ["id", "email", "password", "createdAt", "updatedAt"],
  UserUpdateWithoutRoleInput: ["email", "password", "createdAt", "updatedAt", "profile", "meals", "weighIns", "workouts", "recipes"],
